...
<header class="header">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2">
            <!-- Solo Ver pedidos + Cerrar sesión -->
...
<div class="container py-4 wrapper">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>Clientes de la tienda</h3>
        <button class="btn btn-primary" id="btnNuevo">Nuevo cliente</button>
    </div>

    <div class="tabla-wrapper">
        <table id="tablaClientes" class="table table-striped align-middle" style="width:100%">
            <thead>
            <tr>
                <th>ID</th>
                <th>Nombre</th>
...
$(document).ready(function () {
    ...
    // 1. DataTable (SIN columna creado_en)
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.success) {
                    ...
                    alert(resp.message || resp.error || 'Ocurrió un error');
                }
            },
            error: function () {
